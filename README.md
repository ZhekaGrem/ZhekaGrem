...
[![Telegram](https://img.shields.io/badge/Telegram-26A5E4?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/yevhenii_hrem)
...
Full stack developer based in Lviv. I write TypeScript on the frontend (React, Next.js) and Python or Node on the backend (Django, Express, aiogram). I lean on Go when a client asks for it.

Last year most of my work has been AI-adjacent: RAG pipelines, multi-channel chatbots across Telegram / Discord / Instagram / Messenger / WhatsApp, and LLM features bolted onto production apps. Before that, six years of regular web — e-commerce, dashboards, a multilingual corporate site, an automotive CRM.

I ship things end to end — spec to deploy to the VPS that serves them.
...
![FastAPI-style](https://img.shields.io/badge/django--ninja-0C7B4C?style=flat-square)
